...
class NumberTileGameViewController : UIViewController, GameModelProtocol {
    ...
    init(dimension d: Int, threshold t: Int) {
        ...
        dimension = d > 2 ? d : 2
        threshold = t < 64 ? t : 64
        print("In init method of NumberTileGameViewController \(dimension),\(threshold)")
    ...
    func reset() {
        ...
        // m.insertTileAtRandomLocation(withValue: 2)
        m.insertTileAtRandomLocation(withValue: 2048)
        m.insertTileAtRandomLocation(withValue: 2048)
    }
    ...
    func followUp() {
        ...
        //veebha
        m.insertTileAtRandomLocation(withValue: randomVal == 1 ? 1024 : 2048)
