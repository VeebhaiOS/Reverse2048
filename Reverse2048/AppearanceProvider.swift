...
class AppearanceProvider: AppearanceProviderProtocol {
    ...
    func numberColor(_ value: Int) -> UIColor {
        switch value {
        case 2, 4:
            return UIColor.white//UIColor(red: 119.0/255.0, green: 110.0/255.0, blue: 101.0/255.0, alpha: 1.0)
        default:
            return UIColor(red: 119.0/255.0, green: 110.0/255.0, blue: 101.0/255.0, alpha: 1.0)//UIColor.white
        }
    }
